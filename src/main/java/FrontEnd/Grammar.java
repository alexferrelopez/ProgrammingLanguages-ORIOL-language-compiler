...
public class Grammar {
     ...
     */
    private final Map<frontend.NonTerminalSymbol, List<List<frontend.AbstractSymbol>>> grammar = new HashMap<>();
    private final List<NonTerminalSymbol> noTerminalList = new LinkedList<>();

    public Map<frontend.NonTerminalSymbol, List<List<AbstractSymbol>>> getGrammar(){
        return this.grammar;
    }
